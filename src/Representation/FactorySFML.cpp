...
namespace factory
{
    ...
    std::shared_ptr<logic::BlinkyEntity> FactorySFML::create_blinky(const std::vector<logic::Position>& ghost_house,
            const std::vector<logic::Position>& ghost_gate, float velX_unit, float velY_unit)
    {
        std::shared_ptr<logic::BlinkyEntity> model = std::make_shared<logic::BlinkyEntity>(ghost_house, ghost_gate, velX_unit, velY_unit);
    ...
    std::shared_ptr<logic::PinkyEntity> FactorySFML::create_pinky(const std::vector<logic::Position>& ghost_house,
        const std::vector<logic::Position>& ghost_gate, float velX_unit, float velY_unit)
    {
        std::shared_ptr<logic::PinkyEntity> model = std::make_shared<logic::PinkyEntity>(ghost_house, ghost_gate, velX_unit, velY_unit);
    ...
    const std::vector<logic::Position>& ghost_gate, float velX_unit, float velY_unit)
    {
        std::shared_ptr<logic::InkyEntity> model = std::make_shared<logic::InkyEntity>(ghost_house, ghost_gate, velX_unit, velY_unit);
    ...
    const std::vector<logic::Position>& ghost_gate, float velX_unit, float velY_unit)
    {
        std::shared_ptr<logic::ClydeEntity> model = std::make_shared<logic::ClydeEntity>(ghost_house, ghost_gate, velX_unit, velY_unit);
